        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Define y rastrea objetivos para mantener tu startup enfocada
            </p>
          </div>
          ...
          <div className="space-y-8">
            <Card className="border-2 border-blue-100/50 shadow-xl bg-white/90 backdrop-blur-sm">
              ...
              <CardContent className="space-y-4 text-gray-700 leading-relaxed">
                <p className="text-lg">
                  Los <strong>OKRs (Objetivos y Resultados Clave)</strong> son una metodología para establecer objetivos ambiciosos y medir tu progreso. Te ayudan a mantener el enfoque y medir el éxito de tu startup.
                </p>
              </CardContent>
            </Card>
          </div>
